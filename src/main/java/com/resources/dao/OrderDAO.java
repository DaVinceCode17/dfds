...
public class OrderDAO {
    ...
    public Order moveToFold(int orderId) throws SQLException {
        // Check if order has Iron in services
        Order order = getOrderById(orderId, "to_iron_orders");
        if (order != null) {
            return moveOrder(orderId, "to_iron_orders", "to_fold_orders", "to_fold");
        } else {
            return moveOrder(orderId, "to_dry_orders", "to_fold_orders", "to_fold");
        }
    }
    ...
    public List<Order> getOrdersByCustomer(int customerId) throws SQLException {
        List<Order> list = new ArrayList<>();
        String sql = "SELECT 'set_pricing' as status, o.id, o.customer_id, o.services, o.service_type, o.queue_number, o.weight, o.price, o.created_at, o.updated_at, c.first_name, c.last_name FROM set_pricing_orders o LEFT JOIN customers c ON o.customer_id = c.id WHERE o.customer_id = ? " +
                     "UNION ALL " +
                     "SELECT 'pending' as status, o.id, o.customer_id, o.services, o.service_type, o.queue_number, o.weight, o.price, o.created_at, o.updated_at, c.first_name, c.last_name FROM pending_orders o LEFT JOIN customers c ON o.customer_id = c.id WHERE o.customer_id = ? " +
                     "UNION ALL " +
